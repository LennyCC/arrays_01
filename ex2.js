 ...
 * 
 * Añade un condicional if... que compruebe si, la variable "siguiente_pez" es "Nemo". Si es "Nemo" muestra por el 
 * terminal un mensaje: "He encontrado a Nemo!". Cada vez que no encuentre el pez Nemo, escribe "Este pez NO es Nemo!"
 *
